...
1. **Personal use only.** This software may be used solely by individual persons for
   their own personal, non-commercial purposes.

2. **No commercial use.** Use of this software for any commercial purpose — including
...
3. **No redistribution.** This software may not be copied, modified, merged, published,
   distributed, sublicensed, sold, or otherwise transferred to any third party, in
   whole or in part, in any form.

4. **No derivative works.** You may not modify, adapt, translate, reverse engineer,
